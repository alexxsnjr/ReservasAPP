        ...
        <div id="contenedor" class="col-md-6 col-md-offset-3">
            ...
            <div class="box box-widget widget-user">
                ...
                <div id="fondo" class="widget-user-header bg-blue-active">
                    <h3 id="nombreCentro" class="widget-user-username">{{ $centro[0]->nombre }}</h3>
                    ...
                    <div class="row">
                        <div class="col-sm-4 border-right">
                            <div class="description-block">
                                <a href="{{ route('importarDatos') }}" class="btn btn-default animsition-link">Omitir</a>
                            </div>
                            <!-- /.description-block -->
                        </div>
                        <!-- /.col -->
                        ...
                        <div class="col-sm-4">
                            <div class="description-block">
                                <form class="form-horizontal" action="{{ route('datosCentro.color' , $centro[0]->id)}}" method="POST">
